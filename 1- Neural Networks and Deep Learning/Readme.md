...
- <span style="background-color: yellow"> RELU </span> stands for rectified linear unit is the most popular activation function right now that makes deep NNs train faster now.
